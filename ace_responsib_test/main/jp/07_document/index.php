...
<div class="container">
  <div class="header"><a href="../index.html">　<img src="../../images/ace-logo-20131111.png" alt="" width="141" height="93" /></a>　 
    <!-- end .header --><img src="../../images/ace-logo-title-ver.4.png" alt="ACE Project title" width="557" height="65" /><img src="../../images/button_d.png" width="17" height="90" /><a href="../../en/07_document/index.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','../../images/button_en_on.png',1)"><img src="../../images/button_en_a.png" name="Image1" width="46" height="89" border="0" id="Image1" /></a> <img src="../../images/button_d.png" width="17" height="90" /><a href="../../sitemap/index.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','../../images/sitemap_jp_on.png',1)"><img src="../../images/sitemap_jp_a (2).png" name="Image2" width="73" height="89" border="0" id="Image2" /></a></div>
    <div class="content">
<style>
#normal li ul{
  display: none;
...
<li><a href="../08_contrib/index.html"class="g">Contrib</a></li>
  ...
  <p> 　　 <!--　<span class="sitemap"><a href="../index.html">ホーム</a> ＞ ドキュメント</span>--></p>
    <p>&nbsp;</p>
    <p><img src="../../images/obi_document_jp.png" alt="" width="900" height="38" /></p>
    <p>&nbsp;</p>
     ...
     <table width="72%" height="5"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="58">&nbsp;</td>
        <td width="633" height="5"><strong class="subsubtitle">Specification of Advanced Communication Primitives (ACP) Library&nbsp;</strong></tr>
    </table>    
<table width="97%" height="16" border="0" cellpadding="0" cellspacing="0">
  ...
  <table width="93%" height="41" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="58">&nbsp;</td>
    <td width="835" height="41"> <img src="../../images/arrow19-065.gif" width="16" height="16" /> <a href="acp-ver1.2-doxgen-html-jp/index.html" target="_blank" class="subsubtitle"><u><strong>HTML</strong></u></a></td></tr>
</table>
  <table width="93%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="58">&nbsp;</td>
    <td width="835" height="43"><img src="../../images/arrow19-065.gif" width="16" height="16" /> <a href="acp-1.2-spec.pdf" target="_blank" class="subsubtitle"><u><strong>PDF</strong></u></a> <img src="../../images/pdficon_small.png" width="16" height="16" alt="icon" /></td></tr>
</table>
 <table width="93%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="58">&nbsp;</td>
...
<p align="center" class="content">&nbsp;</p>
  <!-- end .content --></div>
   <div class="footer">
    ...
    <!-- end .footer -->　
    <a href="http://creativecommons.org/licenses/by-sa/2.1/jp/deed.en" target="_blank"><img src="../../images/by-sa.png" width="88" height="31" /></a>
